...
pub fn get_version() -> String {
    unsafe {
        CStr::from_ptr(beagleGetVersion())
            .to_str()
            .unwrap()
            .to_owned()
    }
...
pub fn get_citation() -> String {
    unsafe {
        CStr::from_ptr(beagleGetCitation())
            .to_str()
            .unwrap()
            .to_owned()
    }
...
pub fn get_resource_list() -> Vec<Resource> {
    unsafe {
        ...
        let slice: &[BeagleResource] =
            std::slice::from_raw_parts(res_list.list, res_list.length as usize);
        let mut res_vec = vec![];
        for res in slice {
...
pub fn create_instance(
    ...
    compactBufferCount: i32,
    stateCount: i32,
    patternCount: i32,
    eigenBufferCount: i32,
    matrixBufferCount: i32,
    categoryCount: i32,
    ...
    unsafe {
        ...
        let instance = beagleCreateInstance(
            ...
            rl,
            rl_len,
            preferenceFlags.bits(),
            requirementFlags.bits(),
            &mut returnInfo,
        );
        ...
        (
            ...
            InstanceDetails {
                ...
                resourceName: CStr::from_ptr(returnInfo.resourceName)
                    .to_str()
                    .unwrap()
                    .to_owned(),
                implName: CStr::from_ptr(returnInfo.implName)
                    .to_str()
                    .unwrap()
                    .to_owned(),
                implDescription: CStr::from_ptr(returnInfo.implDescription)
                    .to_str()
                    .unwrap()
                    .to_owned(),
...
pub fn finalize() -> ReturnCode {
    unsafe { transmute(beagleFinalize() as i8) }
}

pub fn finalize_instance(instance: i32) -> ReturnCode {
    unsafe { transmute(beagleFinalizeInstance(instance) as i8) }
}
...
pub fn get_partials(
    ...
    unsafe {
        transmute(
            beagleGetPartials(instance, bufferIndex, scaleIndex, outPartials.as_mut_ptr()) as i8,
        )
    }
}
...
pub fn get_scale_factors(
    instance: i32,
    srcScalingIndex: i32,
    outScaleFactors: &mut [f64],
) -> ReturnCode {
    unsafe {
        transmute(
            beagleGetScaleFactors(instance, srcScalingIndex, outScaleFactors.as_mut_ptr()) as i8,
        )
    }
}

pub fn get_site_derivatives(
    instance: i32,
    outFirstDerivatives: &mut [f64],
    outSecondDerivatives: &mut [f64],
) -> ReturnCode {
    unsafe {
        transmute(beagleGetSiteDerivatives(
            instance,
...
pub fn get_site_log_likelihoods(instance: i32, outLogLikelihoods: &mut [f64]) -> ReturnCode {
    unsafe {
        transmute(beagleGetSiteLogLikelihoods(instance, outLogLikelihoods.as_mut_ptr()) as i8)
    }
}

pub fn get_transition_matrix(instance: i32, matrixIndex: i32, outMatrix: &mut [f64]) -> ReturnCode {
    unsafe {
...
pub fn remove_scale_factors(
    ...
    unsafe {
        transmute(beagleRemoveScaleFactors(
            instance,
            scaleIndices.as_ptr(),
...
pub fn remove_scale_factors_by_partition(
    ...
    unsafe {
        transmute(beagleRemoveScaleFactorsByPartition(
            instance,
            scaleIndices.as_ptr(),
            scaleIndices.len() as i32,
            cumulativeScaleIndex,
...
pub fn reset_scale_factors(instance: i32, cumulativeScaleIndex: i32) -> ReturnCode {
    unsafe { transmute(beagleResetScaleFactors(instance, cumulativeScaleIndex) as i8) }
}
...
pub fn reset_scale_factors_by_partition(
    ...
    unsafe {
        transmute(
            beagleResetScaleFactorsByPartition(instance, cumulativeScaleIndex, partitionIndex)
                as i8,
        )
    }
}
...
pub fn set_category_rates(instance: i32, inCategoryRates: &[f64]) -> ReturnCode {
    unsafe { transmute(beagleSetCategoryRates(instance, inCategoryRates.as_ptr()) as i8) }
}

pub fn set_category_rates_with_index(
    instance: i32,
    categoryRatesIndex: i32,
    inCategoryRates: &[f64],
) -> ReturnCode {
    unsafe {
        transmute(beagleSetCategoryRatesWithIndex(
            instance,
            categoryRatesIndex,
...
pub fn set_category_weights(
    instance: i32,
    categoryWeightsIndex: i32,
    inCategoryWeights: &[f64],
) -> ReturnCode {
    unsafe {
        transmute(beagleSetCategoryWeights(
            instance,
...
pub fn set_eigen_decomposition(
    ...
    unsafe {
        transmute(beagleSetEigenDecomposition(
            instance,
            eigenIndex,
...
pub fn set_partials(instance: i32, bufferIndex: i32, inPartials: &[f64]) -> ReturnCode {
    unsafe { transmute(beagleSetPartials(instance, bufferIndex, inPartials.as_ptr()) as i8) }
}

pub fn set_pattern_partitions(
    instance: i32,
    partitionCount: i32,
    inPatternPartitions: &[i32],
) -> ReturnCode {
    unsafe {
        transmute(
...
pub fn set_state_frequences(
    ...
    unsafe {
        transmute(beagleSetStateFrequencies(
            instance,
            stateFrequenciesIndex,
            inStateFrequencies.as_ptr(),
        ) as i8)
    }
}

pub fn set_tip_partials(instance: i32, tipIndex: i32, inPartials: &[f64]) -> ReturnCode {
    unsafe { transmute(beagleSetTipPartials(instance, tipIndex, inPartials.as_ptr()) as i8) }
}

pub fn set_tip_states(instance: i32, tipIndex: i32, inStates: &[i32]) -> ReturnCode {
    unsafe { transmute(beagleSetTipStates(instance, tipIndex, inStates.as_ptr()) as i8) }
}
...
pub fn set_transition_matrices(
    ...
    unsafe {
        transmute(beagleSetTransitionMatrices(
            instance,
...
pub fn set_transition_matrix(
    ...
    unsafe {
        transmute(
            beagleSetTransitionMatrix(instance, matrixIndex, inMatrix.as_ptr(), paddedValue) as i8,
        )
    }
}
...
pub fn update_partials(
    ...
    unsafe {
        ...
        transmute(beagleUpdatePartials(
            instance,
...
pub fn update_partials_by_partition(
    instance: i32,
    operations: Vec<OperationByPartition>,
) -> ReturnCode {
    unsafe {
        let mut beagle_ops = vec![];
        for op in operations {
        ...
        transmute(beagleUpdatePartialsByPartition(
            instance,
            beagle_ops.as_slice().as_ptr(),
            beagle_ops.len() as i32,
        ) as i8)
...
pub fn update_transition_matrices(
    ...
    unsafe {
        ...
        transmute(beagleUpdateTransitionMatrices(
            instance,
            eigenIndex,
...
pub fn update_transition_matrices_with_multiple_models(
    ...
    unsafe {
        ...
        transmute(beagleUpdateTransitionMatricesWithMultipleModels(
            instance,
            eigenIndices.as_ptr(),
...
pub fn wait_for_partials(instance: i32, destinationPartials: &[i32]) -> ReturnCode {
    unsafe {
        transmute(beagleWaitForPartials(
            instance,
            destinationPartials.as_ptr(),
